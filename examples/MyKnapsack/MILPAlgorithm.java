...
public class MILPAlgorithm extends DatacenterBroker{
	...
	public  Hashtable<BagofTask,KnapsackResult>recordMILP;
	...
	public MILPAlgorithm(String name) throws Exception {		
		super(name);
		...
		recordMILP= new Hashtable<BagofTask, KnapsackResult>();
