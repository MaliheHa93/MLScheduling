...
class FastQSplit extends AppJob {
    ...
    public FastQSplit(Genome genome, String name, String version, String jobID, int laneID) throws Exception {
    ...
    @Override
    protected void addChildren(List<? extends AppJob> children) throws Exception {
...
class FilterContams extends AppJob {
    ...
    public FilterContams(Genome genome, String name, String version, String jobID, int laneID, int splitID) throws Exception {
        super(genome, Genome.namespace, name, version, jobID);
    }

    @Override
    protected void addChild(AppJob child) throws Exception {
...
class Sol2Sanger extends AppJob {
    ...
    public Sol2Sanger(Genome genome, String name, String version, String jobID, int laneID, int splitID) throws Exception {
        super(genome, Genome.namespace, name, version, jobID);
    }
...
class Fast2Bfq extends AppJob {
    ...
    public Fast2Bfq(Genome genome, String name, String version, String jobID, int laneID, int splitID) throws Exception {
        super(genome, Genome.namespace, name, version, jobID);
    }
...
class MaqMap extends AppJob {
    ...
    public MaqMap(Genome genome, String name, String version, String jobID, int laneID, int splitID) throws Exception {
        super(genome, Genome.namespace, name, version, jobID);
...
class MapMerge extends AppJob {
    ...
    public MapMerge(Genome genome, String name, String version, String jobID, int mapID) throws Exception {
        super(genome, Genome.namespace, name, version, jobID);
        this.mapID = mapID;
    }
...
class MaqIndex extends AppJob {
    ...
    public MaqIndex(Genome genome, String name, String version, String jobID) throws Exception {
        super(genome, Genome.namespace, name, version, jobID);
    }
...
class PileUp extends AppJob {
    ...
    public PileUp(Genome genome, String name, String version, String jobID) throws Exception {
        super(genome, Genome.namespace, name, version, jobID);
