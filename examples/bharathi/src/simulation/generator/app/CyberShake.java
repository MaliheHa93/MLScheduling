...
class ExtractSGT extends AppJob {
    ...
    public ExtractSGT(CyberShake cybershake, String name, String version, String jobID, String prefix) throws Exception {
...
class SeismogramSynthesis extends AppJob {
    ...
    public SeismogramSynthesis(CyberShake cybershake, String name, String version, String jobID, String prefix) throws Exception {
        super(cybershake, CyberShake.NAMESPACE, name, version, jobID);
        this.prefix = prefix;
        this.jobID = jobID;
...
class PeakValCalcOkaya extends AppJob {
    ...
    public PeakValCalcOkaya(CyberShake cybershake, String name, String version, String jobID) throws Exception {
        super(cybershake, CyberShake.NAMESPACE, name, version, jobID);
...
class ZipSeis extends AppJob {
    ...
    public ZipSeis(CyberShake cybershake, String name, String version, String jobID) throws Exception {
        super(cybershake, CyberShake.NAMESPACE, name, version, jobID);
...
class ZipPSA extends AppJob {
    ...
    public ZipPSA(CyberShake cybershake, String name, String version, String jobID) throws Exception {
        super(cybershake, CyberShake.NAMESPACE, name, version, jobID);
    }
