...
public class Montage extends AbstractApplication {
    ...
    public void constructWorkflow() throws Exception {
...
class MProjectPP extends AppJob {
    ...
    public MProjectPP(Montage montage, String name, String version, String jobID) throws Exception {
...
class MDiffFit extends AppJob {
    ...
    public MDiffFit(Montage montage, String name, String version, String jobID) throws Exception {
        super(montage, Montage.namespace, name, version, jobID);
...
class MConcatFit extends AppJob {
    ...
    public MConcatFit(Montage montage, String name, String version, String jobID) throws Exception {
        super(montage, Montage.namespace, name, version, jobID);
...
class MBgModel extends AppJob {
    ...
    public MBgModel(Montage montage, String name, String version, String jobID) throws Exception {
        super(montage, Montage.namespace, name, version, jobID);
    ...
    @Override
    public void addChildren(List<? extends AppJob> children) throws Exception {
...
class MBackground extends AppJob {
    ...
    public MBackground(Montage montage, String name, String version, String jobID) throws Exception {
        super(montage, Montage.namespace, name, version, jobID);
    ...
    @Override
    public void addChild(AppJob child) throws NumberFormatException, Exception {
...
class MImgTbl extends AppJob {
    ...
    public MImgTbl(Montage montage, String name, String version, String jobID) throws Exception {
        super(montage, Montage.namespace, name, version, jobID);
...
class MAdd extends AppJob {
    ...
    public MAdd(Montage montage, String name, String version, String jobID) throws Exception {
        super(montage, Montage.namespace, name, version, jobID);
...
class MShrink extends AppJob {
    ...
    public MShrink(Montage montage, String name, String version, String jobID) throws Exception {
        super(montage, Montage.namespace, name, version, jobID);
...
class MJPEG extends AppJob {
    ...
    public MJPEG(Montage montage, String name, String version, String jobID) throws Exception {
        super(montage, Montage.namespace, name, version, jobID);
    }
