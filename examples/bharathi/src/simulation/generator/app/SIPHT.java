package bharathi.src.simulation.generator.app;

import java.util.Set;

import bharathi.src.simulation.generator.util.Distribution;
import bharathi.src.simulation.generator.util.Misc;
...
public class SIPHT extends AbstractApplication {
    ...
    protected void constructWorkflow() throws Exception {
        if (numJobs < 30) {
    ...
    protected void constructSubWorkflow(int remaining) throws Exception {
        if (remaining <= 0) {
...
class Findterm extends AppJob {
    ...
    public Findterm(SIPHT sipht, String name, String version, String jobID) throws Exception {
    ...
    public void addChild(AppJob child) throws Exception {
...
class RNAMotif extends AppJob {
    ...
    public RNAMotif(SIPHT sipht, String name, String version, String jobID) throws Exception {
        super(sipht, SIPHT.NAMESPACE, name, version, jobID);
        input(SIPHT.CODE + ".fna", sipht.generateLong("CODE.fna"));
...
class Transterm extends AppJob {
    ...
    public Transterm(SIPHT sipht, String name, String version, String jobID) throws Exception {
...
class Blast extends AppJob {
    ...
    public Blast(SIPHT sipht, String name, String version, String jobID) throws Exception {
        super(sipht, SIPHT.NAMESPACE, name, version, jobID);
...
class Patser extends AppJob {
    ...
    public Patser(SIPHT sipht, String name, String version, String jobID) throws Exception {
        super(sipht, SIPHT.NAMESPACE, name, version, jobID);
        this.jobID = jobID;
...
class PatserConcate extends AppJob {
    ...
    public PatserConcate(SIPHT sipht, String name, String version, String jobID) throws Exception {
        super(sipht, SIPHT.NAMESPACE, name, version, jobID);
...
class SRNA extends AppJob {
    ...
    public SRNA(SIPHT sipht, String name, String version, String jobID) throws Exception {
        super(sipht, SIPHT.NAMESPACE, name, version, jobID);
...
class FFNParse extends AppJob {
    ...
    public FFNParse(SIPHT sipht, String name, String version, String jobID) throws Exception {
        super(sipht, SIPHT.NAMESPACE, name, version, jobID);
...
class BlastCandidate extends AppJob {
    ...
    public BlastCandidate(SIPHT sipht, String name, String version, String jobID) throws Exception {
        super(sipht,
...
class BlastQRNA extends AppJob {
    ...
    public BlastQRNA(SIPHT sipht, String name, String version, String jobID) throws Exception {
...
class BlastSynteny extends AppJob {
    ...
    public BlastSynteny(SIPHT sipht, String name, String version, String jobID) throws Exception {
        super(sipht, SIPHT.NAMESPACE, name, version, jobID);
...
class SRNAAnnotate extends AppJob {
    ...
    public SRNAAnnotate(SIPHT sipht, String name, String version, String jobID) throws Exception {
        super(sipht, SIPHT.NAMESPACE, name, version, jobID);
...
class BlastParalogues extends AppJob {
    ...
    public BlastParalogues(SIPHT sipht, String name,
            String version, String jobID) throws Exception {
        super(sipht, SIPHT.NAMESPACE, name, version, jobID);
        input("xdformat", sipht.generateLong("xdformat"));
        input("blasta", sipht.generateLong("blasta"));
        input("time", sipht.generateLong("time"));
