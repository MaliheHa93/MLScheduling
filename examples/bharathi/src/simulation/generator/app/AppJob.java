...
public abstract class AppJob extends Job {
    ...
    protected AppJob(Application app, String namespace, String name, String version, String jobID) throws Exception {
    ...
    protected void addLink(AppJob child, String filename) throws Exception {
        addLink(child, filename, 0);
    }

    protected void addLink(AppJob child, String filename, long size) throws Exception {
    ...
    protected void addLink(AppJob child, AppFilename out, AppFilename in) throws Exception {
