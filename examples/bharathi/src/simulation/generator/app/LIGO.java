...
class TmpltBank extends AppJob {
    ...
    public TmpltBank(LIGO ligo, String name, String version, String jobID) throws Exception {
...
class Thinca extends AppJob {
    ...
    public Thinca(LIGO ligo, String name, String version, String jobID, int level) throws Exception {
        super(ligo, LIGO.namespace, name, version, jobID);
        this.setLevel(level);
    ...
    private void generateOutput(AppJob child) throws Exception {
...
class TrigBank extends AppJob {
    ...
    public TrigBank(LIGO ligo, String name, String version, String jobID) throws Exception {
        super(ligo, LIGO.namespace, name, version, jobID);
        this.setLevel(3);
