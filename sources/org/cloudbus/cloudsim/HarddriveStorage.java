...
public class HarddriveStorage implements Storage {
	 ...
	 * 
	 * @param l the size of a file in MB
	 * @return the seek time in seconds
	 */
	private double getSeekTime(long l) {
		double result = 0;
	 ...
	 * 
	 * @param l the size of the transferred file
	 * @return the transfer time in seconds
	 */
	private double getTransferTime(long l) {
		double result = 0;
		if (l > 0 && capacity != 0) {
			result = (l * maxTransferRate) / capacity;
		}
