...
public class File {
	 ...
	 * @param l file size is in MBytes
	 ...
	 *             </ul>
	 */
	public File(String fileName, long l) throws ParameterException {
		...
		name = fileName;
		attribute = new FileAttribute(fileName, l);
		transactionTime = 0;
	}
	 ...
	 * 
	 * @param sizeinMb the file size (in MBytes)
	 * @return <tt>true</tt> if successful, <tt>false</tt> otherwise
	 */
	public boolean setFileSize(long sizeinMb) {
		return attribute.setFileSize(sizeinMb);
	}
