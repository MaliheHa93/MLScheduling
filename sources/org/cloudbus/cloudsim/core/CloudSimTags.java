...
public class CloudSimTags {
	...
	public static final int NextCycle = BASE + 48;
	 //my tags 
    /**
     * Denotes an internal event to initial broker and load data
     */
    public static final int REGISTER_BROKER = BASE + 49;
    
    public static final int INITIAL_BROKER = BASE + 50;
    
    public static final int REQUEST_ON_DEMAND_VM = BASE + 51;
    
    public static final int START_ON_DEMAND_VM_NEXT_TIME_CYCLE = BASE + 52;
    
    public static final int SUBMIT_TASK_TO_ON_DEMAND_VM = BASE + 53;
    
    public static final int ON_DEMAND_VM_TASK_EXECUTION_DONE = BASE + 54;
    
    public static final int VM_EXECUTION_COMPLETED = BASE + 55;
    
    public static final int ON_DEMAND_VM_CONTINUE_EXECUTION = BASE +56;
    
    public static final int REQUEST_VM = BASE + 57;
    
    public static final int REQUEST_VM_SUCCESS = BASE + 58;
    
    public static final int REQUEST_VM_FAILED = BASE + 59;
    
    public static final int START_VM_NEXT_TIME_CYCLE = BASE + 60;
    
    public static final int TERMINATE_VM_IMMIDIATELLY = BASE + 61;
    
    public static final int VM_TERMINATED = BASE + 62;
    
    public static final int SUBMIT_TASK = BASE + 63;
    
    public static final int SUBMIT_TASK_FAILED = BASE + 64;
    
    public static final int TASK_COMPLETED = BASE + 65;
    
    public static final int TASK_FAILED = BASE + 66;
    
    public static final int DEADLINE_REACHED = BASE + 100;
    
    public static final int VM_HARDWARE_FAIL = BASE + 67;
    
    public static final int VM_OUT_OF_BID = BASE + 68;
    
    public static final int VM_ON_BID = BASE + 69;
    
    public static final int SPOT_PRICE_CHANGED = BASE + 70;
    
    public static final int FINISH_SECTION = BASE + 71;
    
    public static final int PROVISIONING_INTERVAL = BASE + 72;
    
    public static final int CRITICAL_TASK_CHECK = BASE + 73;
    
    public static final int SCHEDULING = BASE + 74;
    
    public static final int WORKFLOW_ACCEPT = BASE + 75;
    
    public static final int VM_IDLE = BASE + 76;
